...
namespace NBAapp.Models
{
    public class Team
    {
        ...
        public List<Player> Players { get; set; } = new List<Player>
        {
            ...
            new Player("Jayleen Brown", "SG", 21, 2.01, 102, true, Weakness.Passing, Practice.Passing),
            ...
            new Player("Daniel Theis", "C", 25, 210, 111, true, Weakness.Positioning, Practice.ZoneDefense),
